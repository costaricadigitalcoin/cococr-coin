...
export BUILDER_IMAGE_NAME="cococostarica-builder-$BUILD_TARGET-$JOB_NUMBER"
...
if [ "$BUILD_TARGET" = "arm-linux" ]; then
  ...
  export USE_SHELL="/bin/cococostarica"
  export PYZMQ=true
  export RUN_TESTS=true
  ...
  export CPPFLAGS="-DDEBUG_LOCKORDER -DENABLE_COCOCR_DEBUG"
  export PYZMQ=true
  export RUN_TESTS=true

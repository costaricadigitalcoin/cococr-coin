...
EXPECTED_HOLDER_NAMES = [
    ...
    "The COCOCostaRica Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a COCOCostaRica Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The COCOCostaRica Core developers'
...
Arguments:
    <base_directory> - The base directory of COCOCostaRica Core source code repository.
"""
...
Arguments:
    <file> - A source file in the COCOCostaRica Core repository.
"""

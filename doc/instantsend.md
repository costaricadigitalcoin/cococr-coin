...
This mechanism has been integrated into Bitcore-Node-COCOCostaRica which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cococostaricapay/insight-api-cococostarica#web-socket-api](https://github.com/cococostaricapay/insight-api-cococostarica#web-socket-api)
* API: [https://github.com/cococostaricapay/insight-api-cococostarica#instantsend-transactions](https://github.com/cococostaricapay/insight-api-cococostarica#instantsend-transactions)

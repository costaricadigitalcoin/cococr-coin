...
This document provides guidelines for internationalization of the COCOCostaRica Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cococostarica_en.ts` remains unchanged.

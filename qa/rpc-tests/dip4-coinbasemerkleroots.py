...
from test_framework.test_framework import COCOCostaRicaTestFramework
...
class LLMQCoinbaseCommitmentsTest(COCOCostaRicaTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as COCOCostaRicaTestFramework doesn't support this atm)

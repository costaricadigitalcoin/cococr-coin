...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner COCOCostaRica address\n"
            "  payee          - Print the masternode payout COCOCostaRica address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting COCOCostaRica address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "cococostarica",               "masternode",             &masternode,             true,  {} },
    { "cococostarica",               "masternodelist",         &masternodelist,         true,  {} },
    { "cococostarica",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "cococostarica",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};

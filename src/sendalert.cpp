...
2. run cococostaricad with -printalert or -sendalert like this:
   /path/to/cococostaricad -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.cococostarica.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/COCOCostaRica Core:0.12.0.58/"));

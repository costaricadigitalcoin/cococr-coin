...
#define BOOST_TEST_MODULE COCOCostaRica Test Suite

#include "test_cococostarica.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_cococostarica_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
